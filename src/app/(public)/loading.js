    ...
    <main className="min-h-screen bg-gray-50 dark:bg-zinc-950 transition-colors duration-300">
      <div className="max-w-6xl mx-auto p-6">
        <header className="mb-12 text-center pt-8 flex flex-col items-center">
          <div className="h-10 w-10 bg-zinc-200 dark:bg-zinc-800 rounded-full animate-pulse mb-4" />
        ...
        <div className="flex flex-wrap justify-center gap-8 w-full">
          {[1, 2, 3].map((i) => (
            ...
            >
              <div className="border border-zinc-200 dark:border-zinc-800 rounded-2xl overflow-hidden bg-white dark:bg-zinc-900 h-[400px]">
                <div className="h-48 bg-zinc-100 dark:bg-zinc-800/50 animate-pulse" />
                <div className="p-5 space-y-4">
                  <div className="h-6 w-3/4 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse" />
                  <div className="h-4 w-full bg-zinc-50 dark:bg-zinc-900 rounded animate-pulse" />
